...
ese_sets = {
    "ESR": "./data/ESR/ESR.txt",
    "Ke400_ESEs": "./data/Ke400_ESEs/Ke400_ESEs.txt",
    "PESE": "./data/PESE/PESE.txt",
    "RESCUE": "./data/RESCUE/RESCUE.txt",
    "INT3": "./data/CaceresHurstESEs_INT3/CaceresHurstESEs_INT3.txt",
    "RBP_motifs": "./data/RBP_motifs/RBP_motifs.txt",
    "RBP_motifs_filtered": "./data/RBP_motifs/filtered_RBP_motifs_nd.txt"
}
